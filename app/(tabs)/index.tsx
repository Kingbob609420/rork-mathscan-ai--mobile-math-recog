      ...
      >
        <View style={styles.content}>
          <View style={styles.logoContainer}>
            ...
            <Text style={[styles.appName, { color: theme.isDark ? '#FFFFFF' : '#FFFFFF' }]}>MathScan AI</Text>
            <Text style={[styles.tagline, { color: theme.isDark ? 'rgba(255,255,255,0.8)' : 'rgba(255,255,255,0.8)' }]}>Point. Aim. Shoot.</Text>
          </View>
